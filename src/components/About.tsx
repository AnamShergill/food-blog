...
export default function About() {
  ...
  // Explicitly typing the event parameter for form submission
  ...
  // Explicitly typing the event parameter for input changes
  ...
  return (
    ...
    >
      <motion.div
        className="container w-1/2 bg-pink-200 py-12 px-6 mb-10 rounded-lg shadow-lg"
      ...
      >
        ...
        <h2
          className="text-5xl mb-6 text-fuchsia-800 text-center"
          style={{
        ...
        >
          Hi there! I'm{" "}
          <span className="text-fuchsia-600 font-semibold">Anam Shergill</span>,
          a passionate food enthusiast, home chef, and a Web Developer. Growing
          up, my love for food was nurtured in a cozy kitchen filled with
          tantalizing aromas and endless culinary experiments. Whether it's
          recreating traditional recipes or inventing something entirely new,
          cooking has always been my creative escape.
        </p>
        <p
          className="text-lg leading-relaxed text-gray-700 mb-8 text-center"
          style={{ fontFamily: "'Merriweather', serif" }}
        ...
        {/* Comment Section */}
        <div className="mt-12">
          <h3 className="text-3xl mb-4 text-center text-fuchsia-800">
            Leave a Comment
          </h3>
          <form onSubmit={handleCommentSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                id="name"
                value={name}
                onChange={handleNameChange} // Used the typed handler
            ...
            <div>
              ...
              <textarea
                id="comment"
                value={comment}
                onChange={handleCommentChange} // Used the typed handler
                className="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg"
                rows={4} 
